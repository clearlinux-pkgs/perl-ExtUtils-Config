...
Source0  : https://cpan.metacpan.org/authors/id/L/LE/LEONT/ExtUtils-Config-0.009.tar.gz
...
%prep
%setup -q -n ExtUtils-Config-0.009
cd %{_builddir}/ExtUtils-Config-0.009
pushd ..
cp -a ExtUtils-Config-0.009 buildavx2
popd
